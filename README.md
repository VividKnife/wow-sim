...
已有可玩的网页、确定性战斗引擎、多角色账号、独立资产与活动、共享实例、死亡矿井和暴风城监狱流程。职业系统已扩展到经典旧世九职业的 1—60 级；世界已扩展为联盟与部落的 1—40 级节点区域、六大主城和 14 条地下城路线，八种族使用各自出生地。导入了 1,838 条任务记录；新增脚本任务与地图路线包含明确标注的改编，尚不是原版内容逐条复刻。覆盖范围、再生成和限制见 [1—40 级世界扩展](docs/development/world-1-40.md)。

暴风城监狱包含完整遭遇路线、六项副本任务与通往乌瑞恩的图章的调查任务链。地下城 tab 提供经典旧世 28 个地下城分区的首领和掉落手册，支持搜索与物品筛选；死亡矿井和监狱可实际挑战，并分别保存进度。实现范围、验证与来源限制见 [监狱及地下城手册](docs/development/stockades.md)。
...
职业任务交付接入技能奖励，同时保留训练师职业解锁改编入口；主城提供本地服务和交通。完整 1—60 级野外、原版职业任务链和团队副本不在本次职业扩展中。技能来源与执行登记见 [职业覆盖清单](docs/research/import/classes-60-coverage.json)，验证记录见 [职业验证报告](docs/research/import/classes-60-validation.md)。
