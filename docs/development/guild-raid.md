...
主游戏「地下城」提供公会团和金团两个入口，均使用与5人本相同的地图组件。包含十名首领、十五组小怪、分支路线、目的地推进、暂停、全清规划和检查点。底图使用暴雪客户端原版熔火之心插图，首领和怪群标记按房间叠加，素材来源及校验见[原版地图接入](../research/import/dungeon-maps.md)；首领机制、小怪配置和奖励均为本作改编，不是原版40人的完整数值复刻。
...
公会团十名首领各有六件装备的奖励池，每周首次击败获得一件优先适合团长的史诗装备，共60件常规副本装备。金团每个首领提供三件拍品，保留原有稀有掉落、钱包托管和分金规则。小怪不发首领装备、不开启拍卖。金团首领胜利后暂停路线，拍卖结束再选择下一目的地。
