...
export function recruit(s,id){
 ...
 const c={...newCharacter(candidate.name,candidate.classId,candidate.level),id:'companion-'+id,growthPolicy:'companion',roleId:id,role:candidate.role,recruitedGearCap:candidate.gearCap,joinedAt:s.clock,rage:0,energy:100,combo:0};
