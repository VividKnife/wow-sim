...
function group(){let s=createGame('重置测试',283,0);s.level=20;for(const id of ['warrior','priest','rogue','mage'])s=recruitForTest(s,{type:'recruit',id},0);s.location='deadmines';return s;}
