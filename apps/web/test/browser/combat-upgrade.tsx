...
function Harness(){
 ...
 useEffect(()=>{if(paused)return;const timer=setInterval(()=>setState((s:any)=>advance(s,s.wallAt+250,{dungeonOnline:true}).state),250);return()=>clearInterval(timer);},[paused]);
