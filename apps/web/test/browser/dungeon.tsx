...
function fixture(scenario:string){
 ...
 if(scenario==='powder'){s.dungeon.cursor=dungeonRoute.findIndex(e=>e.id==='dm-gunpowder');for(const guid of dungeonRoute[s.dungeon.cursor].sourceGuids)s.dungeon.defeated[guid]=true;}
 if(scenario==='cannon'){s.dungeon.cursor=dungeonRoute.findIndex(e=>e.id==='dm-cannon');addItem(s,5397);}
