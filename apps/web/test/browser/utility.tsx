...
import {addItem,stats} from '../../lib/game/character.js';
...
function Harness(){
 ...
 useEffect(()=>{const timer=setInterval(()=>setState(s=>advance(s,Date.now(),{dungeonOnline:true}).state),500);return()=>clearInterval(timer);},[]);
