...
const storage='npc-world-preview-v1';
function initial(){
...
function Harness(){
 ...
 useEffect(()=>{const timer=setInterval(()=>{const s=latest.current;if(s.dungeon)try{commit(advance(s,s.wallAt+500).state);}catch(e){setError((e as Error).message);}},500);return()=>clearInterval(timer);},[]);
