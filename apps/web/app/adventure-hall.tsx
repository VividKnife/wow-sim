...
export default function AdventureHall({state:s,data:d,busy,send,compact=false}:GameProps&{compact?:boolean}){
 ...
 return <section className="panel adventure-hall" aria-label="副本组队大厅">
  ...
  {!w.ready?<div className="hall-welcome"><BookOpen size={26}/><div><h3>认识这片世界的冒险者</h3><p>50 位冒险者、九种职业，每次邂逅六人。他们有自己的装备与旅程，结为好友，下次再一起出发。</p></div><Button disabled={locked} onClick={()=>send({type:'npcVisit'})}>走进冒险者大厅</Button></div>:<>
