...
export default function Game(){
 ...
 useEffect(()=>{const update=()=>localClient.current?.visibility(!document.hidden,battleOpen||activeTab==='pvp');update();document.addEventListener('visibilitychange',update);return()=>document.removeEventListener('visibilitychange',update);},[battleOpen,activeTab]);
