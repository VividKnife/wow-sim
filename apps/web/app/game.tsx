...
import {BookOpen,Map as MapIcon,Network,UserRound,UsersRound} from 'lucide-react';
...
</details><footer className="site-footer"><span>1—60 级 · 九职业经典旅程</span><span>共享北郡地图 · 社区经典数据参考 · 2D 冒险改编</span></footer></div></Tabs>}
