...
export default function World({state:s,data:d,busy,revision,send}:GameProps){
 ...
 <div className="interaction-grid">{!d.city&&['全部','人物与服务'].includes(filter)&&<>
