...
export default function Battle({state,data,playback,contentVersion,simulationStatus,busy,send,open,onOpenChange,canLead=true,historical=false,embedded=false}:{embedded?:boolean;historical?:boolean;open:boolean;onOpenChange:(open:boolean)=>void;canLead?:boolean}&GameProps){
