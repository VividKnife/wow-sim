...
export type BattleUnitData={id:string;name:string;hp:number;maxHp:number;classId?:number;creatureType?:number;rank?:number;form?:string;kind?:string;foe?:boolean;removed?:boolean;marker?:'focus'|'control';petUnit?:boolean;totemUnit?:boolean;cast?:BattleCast;swing?:number;target?:string;polyUntil?:number;visual?:{kind?:string;src?:string;species?:string;creatureType?:number}};
