import classDemons from '../../data/class-demons-reference.json' with {type:'json'};
...
import classIcons from '../../data/class-icon-map.json' with { type: 'json' };
...
import journeyAssets from '../../data/journey-item-assets.json' with { type: 'json' };
import supplement from '../../data/quest-supplement-reference.json' with { type: 'json' };
...
import professionTemplates from '../../data/professions-templates.json' with {type:'json'};
